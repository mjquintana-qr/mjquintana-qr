...
Currently completing the MIT/edX Data Science program

I believe data is most powerful when it serves people.
My background in psychology, education, and community work drives me to 
build projects that address real human challenges — from mental health 
to civil rights to community wellbeing. I'm eager to collaborate on 
...
Plotly · NLTK · TextBlob · VADER · gensim · pyLDAvis · NetworkX · 
Prophet · statsmodels · Fairlearn · Faker/Synthea · Streamlit/Gradio

**Tools & Software**
Git · GitHub · Jupyter Notebook · VS Code · Microsoft Excel · 
SQLite · Tableau · Plotly Dash · MLflow · Postman (API testing)

**Platforms & Cloud**
Kaggle · Hugging Face Spaces · Reddit API · OpenAI/Anthropic API · 
ClinicalTrials.gov API · openFDA API · NCBI Entrez API · 
Semantic Scholar/arXiv API · Open Science Framework (OSF)

**UX/UI & Design**
Figma · FigJam · Wireframing · Prototyping · Heuristic evaluation · 
Usability testing · Affinity mapping · User interviews · 
Accessibility standards (WCAG)

**Methods & Concepts**
Machine learning · NLP/text analysis · Time-series forecasting · 
Topic modeling (LDA) · Sentiment analysis · Data cleaning & wrangling · 
